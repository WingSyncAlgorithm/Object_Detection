...
# 載入數據集並預處理
# 創建 CustomDataset 對象path_to_your_model
...
# 載入已經訓練好的權重
model.load_state_dict(torch.load('model_kaggle_6class_processed_epoch50_batchnorm.pth'))
...
# 保存訓練好的模型
torch.save(model.state_dict(), "model_kaggle_6class_processed_epoch0_batchnorm.pth")
