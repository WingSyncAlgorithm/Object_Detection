...
class CNNModel(nn.Module):
    def __init__(self, input_shape, num_classes):
        ...
        self.fc_layers = nn.Sequential(
            nn.Flatten(),
            nn.Linear(conv_output_size * conv_output_size * 16, 128),
            nn.ReLU(),
            nn.Linear(128, 64),
            nn.ReLU(),
...
#使用vgg16网络
    ...
    model_path = "model_k5~cg32ch64ch128ch64ch16_dropout0.95_xavier_deppconnectedch128ch64_SGD_reduce_epoch30__CrabsDolphinblue_ringed_octopusSea UrchinsSeahorseTurtle_Tortoise.pth" # 設置權重文件的路徑，內包含訓練好的權重
